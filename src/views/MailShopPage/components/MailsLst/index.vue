    ...
    >
      <div class="mail_box">
        ...
        <div class="right">
          ...
          <!-- 功能-->
          <div class="function">
            <div @click="replyMail"><van-icon name="comment" /></div>
            <div @click="collectionMail"><van-icon name="star" /></div>
            <div @click="openMail"><van-icon name="weapp-nav" /></div>
          </div>
        </div>
      </div>
    </div>
